...
<nav class="navbar navbar-light bg-light">
  ...
  <ul class="nav">
    ...
    <c:when test="${sessionScope.SESSION_USER_KEY != null}">
		...
		<img alt="" src="/pic/${sessionScope.SESSION_USER_KEY.picture}" style="max-height: 2.5rem" class="rounded img-fluid">
   		</a>
   	 </li>
   	 <li class="nav-item">
   		<div class="dropdown" style="padding-top: 0.4rem;">
		  <a href="#" class="nav-link dropdown-toggle" role="button" id="dropdownMenuButton" 
		  ...
		  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
		    ...
		    <a class="dropdown-item" href="/user/home">我的文章</a>
